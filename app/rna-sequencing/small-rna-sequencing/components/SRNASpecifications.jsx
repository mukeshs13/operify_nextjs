// app/rna-sequencing/small-rna-sequencing/components/SRNASpecifications.jsx
  ...
  const specifications = [
    {
      ...
      content: (
        <div>
          <div className="mb-2">
            <span>Total RNA ≥ 1 μg, Cells≥ 2×10<sup>6</sup>, or Tissue ≥ 500 mg.</span>
          </div>
          <div>
            <strong>
              Please refer to{" "}
    ...
    },
    {
      ...
      content: (
        <div>
          <span>Illumina MiSeq, Nextseq 550</span>
        </div>
      )
    },
    {
