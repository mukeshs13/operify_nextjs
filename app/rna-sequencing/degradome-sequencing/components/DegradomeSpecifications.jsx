// app/rna-sequencing/degradome-sequencing/components/DegradomeSpecifications.jsx
  ...
  const specifications = [
    {
      ...
      content: (
        <div>
          <div className="mb-2">
            <span>Sample type: Total RNA without degradation or DNA contamination</span>
          </div>
          <div className="mb-2">
            <span>Total RNA≥ 20 μg, Minimum Quantity: 15 μg, Concentration≥ 100 ng/µL</span>
          </div>
          <div>
            <strong>
              Please refer to{" "}
